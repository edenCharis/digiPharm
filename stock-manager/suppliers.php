            ...
            switch ($_POST['action']) {
                ...
                case 'delete':
                    ...
                    if ($id > 0) {
                        ...
                        $checkSQL = "SELECT COUNT(*) as count FROM product p join delivery_items d on p.id = d.productId join delivery dt on d.deliveryId= dt.id WHERE dt.supplierId = ? AND dt.pharmacy_id = ?";
