...
@media (max-width: 480px) {
  ...
  .btn-cta-green { width: 100%; justify-content: center; padding: 13px 20px; }
  ...
  .plan-price-val { font-size: 40px; }

  /* SFEC */
  .sfec { padding: 48px 16px; }
  .sfec-text h2 { font-size: 22px; }
  .sfec-box { padding: 18px 24px; }
