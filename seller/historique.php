...
<head>
    ...
    <title>digiPharm - Historique des Ventes</title>
...
<div class="report-section">
    ...
    <form action="generate-sales-report.php" method="GET" class="report-form" target="_blank">
    ...
    <div class="action-buttons">
        <button class="btn-view" onclick="viewOrderDetails(<?php echo $sale['cart_id']; ?>)" title="Voir les détails">
            <i data-lucide="eye"></i>
            Voir
        </button>
    ...
    <script>
        ...
        function printOrder() {
            ...
            const printContent = `
                ...
                <body>
                    <div class="header">
                        <h1>digiPharm - Détails de commande</h1>
