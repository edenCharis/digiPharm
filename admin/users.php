...
function getRoleBadgeClass($role) {
    switch ($role) {
        ...
        case 'CASHIER': return 'badge-success';
          case 'STOCK-MANAGER': return 'badge-secondary';
...
function getRoleText($role) {
    switch ($role) {
        ...
        case 'CASHIER': return 'Caissier';
            case 'STOCK-MANAGER': return 'Gestionnaire de stock';
        default: return $role;
    }
}
?>
...
<head>
    ...
    <title>digiPharm - Gestion des Utilisateurs</title>
